...
wp_enqueue_style('jollibee-style', get_template_directory_uri() . "./style/style.css", microtime());
...
wp_enqueue_script('jollibee-slider', "https://cdnjs.cloudflare.com/ajax/libs/tiny-slider/2.9.4/min/tiny-slider.js", 1.0, [], true );
wp_enqueue_script('jollibee-script', get_template_directory_uri() . "./script/script.js", microtime(), [], true );

if(is_front_page()){
wp_enqueue_script('jollibee-slider-js', get_template_directory_uri() . "./script/slider.js", microtime(), [], true );
}
}
